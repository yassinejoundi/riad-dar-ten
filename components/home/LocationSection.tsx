  ...
  return (
    <section className="bg-cream py-24 md:py-32">
      <div className="mx-auto grid max-w-[1320px] gap-14 px-5 md:px-10 lg:grid-cols-2 lg:gap-24">
        <div>
          <p className="mb-5 font-sans text-xs font-semibold uppercase tracking-[0.24em] text-terracotta">In the medina</p>
          <h2 className="text-balance font-serif text-5xl font-light leading-[1.02] md:text-7xl">Marrakech at the door. Stillness within.</h2>
        </div>
        <div className="lg:pt-12">
          <p className="mb-8 max-w-lg text-pretty font-sans text-lg leading-8 text-midnight-blue/75">Dar Ten sits in Lakssour, one of the medina&apos;s most central quarters. Step out towards the souks and Jemaa el-Fna; return to cool plaster, shade and the sound of water.</p>
