    ...
    <section id="visit" className="scroll-mt-20 bg-tadelakt-green text-white">
      <div className="mx-auto grid max-w-[1440px] lg:grid-cols-2">
        <div className="px-5 py-24 md:px-10 md:py-32 lg:px-16 lg:pr-20">
          ...
          <p className="mt-8 max-w-lg text-pretty font-sans text-base leading-7 text-white/75 md:text-lg md:leading-8">
        ...
        <div id="reserve" className="scroll-mt-20 bg-terracotta px-5 py-24 md:px-10 md:py-32 lg:flex lg:flex-col lg:justify-center lg:px-20">
          ...
          <p className="mt-8 max-w-lg text-pretty font-sans text-base leading-7 text-white/80 md:text-lg md:leading-8">
          ...
          <div className="mt-12 flex flex-wrap gap-x-10 gap-y-4 border-t border-white/25 pt-6 font-sans text-xs text-white/70">
